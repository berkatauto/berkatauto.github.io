...
/// index.html
setInner("indexHeader", `<h1 class="mb-4 text-center pt-10 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white">${jsonData.titleProposal}</h1>`);
